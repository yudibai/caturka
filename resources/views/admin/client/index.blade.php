      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <div class="float-sm-right">
            <a href="{{ route('admin.client.create')}}" class="btn btn-outline-primary min-width-125" data-toggle="click-ripple" style="overflow: hidden; position: relative; z-index: 1;">Add Client</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="card-body p-0">
        <table class="table table-striped">
          ...
          <tbody>
            ...
            <tr>
                <td class="text-center" scope="row">{{ $client->name }}</td>
                <td class="text-center">{{ Carbon::parse($client->created_at)->format('l, d F Y') }}</td>
